<?php if(\berkaPhp\helpers\Auth::is_user_admin()) : ?>
    <form method="POST" action="/generators/run/" style="margin-bottom: 40px;margin-top: 40px;">
        <div class="col-md-6">
...
<?php else: ?>
    <?php \berkaPhp\helpers\RedirectHelper::redirect('/errors/unauthorized'); ?>
<?php endif ?>
